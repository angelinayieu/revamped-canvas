...
function CustomNodeImpl(props: NodeProps) {
  ...
  return (
    <motion.div
      ...
      style={{ width: width ?? NODE_WIDTH, height: height ?? undefined }}
      data-node-id={id}
    ...
    >
      <NodeResizer
        ...
        lineClassName="!border-foreground/20 !border-dashed"
        handleClassName="!h-2.5 !w-2.5 !rounded-sm !border !border-foreground/40 !bg-background"
      />
      ...
      <div
        className={clsx(
          "relative grow border rounded-[10px] transition-colors duration-300 px-5 pb-4 pt-12 shadow-sm bg-card",
